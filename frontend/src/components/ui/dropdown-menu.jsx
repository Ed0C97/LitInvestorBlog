// LitInvestorBlog-frontend/src/components/ui/dropdown-menu.jsx
...
function DropdownMenuSubTrigger({ className, inset, children, ...props }) {
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(
        'focus:bg-light-gray focus:text-antracite data-[state=open]:bg-light-gray data-[state=open]:text-antracite flex cursor-default items-center rounded-sm px-[0.5rem] py-[0.375rem] text-sm outline-hidden select-none data-[inset]:pl-[2rem]',
        className,
      )}
      {...props}
    >
...
function DropdownMenuSubContent({ className, ...props }) {
  return (
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn(
        'bg-white text-antracite data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-[0.5rem] data-[side=left]:slide-in-from-right-[0.5rem] data-[side=right]:slide-in-from-left-[0.5rem] data-[side=top]:slide-in-from-bottom-[0.5rem] z-50 min-w-[8rem] origin-(--radix-dropdown-menu-content-transform-origin) overflow-hidden rounded-md border p-[0.25rem] shadow-lg',
        className,
      )}
      {...props}
    />
